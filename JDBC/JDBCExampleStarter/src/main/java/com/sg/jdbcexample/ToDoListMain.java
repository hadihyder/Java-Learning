...
public class ToDoListMain {
    ...
    private static void updateItem() throws SQLException {
        ...
        try(Connection conn = ds.getConnection()) {
            ...
            PreparedStatement updateStmt = conn.prepareCall(updateSql);
            updateStmt.setString(1, td.getTodo());
            updateStmt.setString(2, td.getNote());
            updateStmt.setBoolean(3, td.isFinished());
            updateStmt.setInt(4, td.getId());
